...
if __name__ == "__main__":
    ...
    parser.add_argument("-i", "--input", default="./data/merged/ontonotes_sg_pred_const")
    parser.add_argument("-o", "--output", default="./data/final/ontonotes_sg_pred_const")
